    ...
    <footer class="qwv-footer" role="contentinfo">
      ...
      <div class="footer-inner container">
        ...
        <div class="footer-brand">
          <a href="/" class="footer-logo-link" aria-label="Qur'an World View">
        ...
        <nav class="footer-nav" aria-label="Footer navigation">
          ...
          <ul role="list" class="footer-nav-links">
            <li><a href="/journey"      class="footer-nav-link">${t('nav_journey')}</a></li>
            <li><a href="/apps"         class="footer-nav-link">${t('nav_apps')}</a></li>
            <li><a href="/library"      class="footer-nav-link">${t('nav_library')}</a></li>
            <li><a href="/blog"         class="footer-nav-link">${t('nav_blog')}</a></li>
            <li><a href="/about"        class="footer-nav-link">${t('nav_about')}</a></li>
            <li><a href="/contact"      class="footer-nav-link">${t('nav_contact')}</a></li>
          </ul>
        </nav>
        ...
        <div class="footer-apps">
          ...
          <ul role="list" class="footer-nav-links">
            <li><a href="/journey#iqra"   class="footer-nav-link">اِقْرَأ — Iqra</a></li>
            <li><a href="/journey#alif"   class="footer-nav-link">أَلِف — Alif</a></li>
            <li><a href="/journey#aamaal" class="footer-nav-link">أَعْمَال — Aamaal</a></li>
            <li><a href="/journey#ahad"   class="footer-nav-link">أَحَد — Ahad</a></li>
            <li><a href="/journey#miftah" class="footer-nav-link">مِفْتَاح — Miftah</a></li>
          </ul>
        </div>
