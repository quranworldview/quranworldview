  ...
  return `
    <nav class="qwv-navbar" id="qwv-navbar" role="navigation" aria-label="Main navigation">
      ...
      <div class="navbar-inner container">
        ...
        <!-- Logo -->
        <a href="/" class="navbar-logo" aria-label="Qur'an World View — Home">
        ...
        <div class="navbar-controls">
          ...
          <!-- Auth CTA -->
          ${loggedIn
            ? `<a href="/dashboard" class="btn btn-outline btn-sm">${t('nav_dashboard')}</a>`
            : `<a href="/login" class="btn btn-primary btn-sm">${t('nav_login')}</a>`
          }
      ...
      <div class="navbar-mobile-overlay" id="navbar-mobile-overlay" inert role="dialog" aria-label="Navigation menu" aria-modal="true">
        <div class="mobile-overlay-inner">
          ...
          <div class="mobile-auth">
            ${loggedIn
              ? `
                <a href="/dashboard" class="btn btn-outline btn-full">${t('nav_dashboard')}</a>
                <button class="btn btn-ghost btn-full" id="mobile-logout-btn">${t('nav_logout')}</button>
              `
              : `<a href="/login" class="btn btn-primary btn-full">${t('nav_login')}</a>`
            }
          </div>
